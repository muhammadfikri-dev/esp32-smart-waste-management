# ⚡ Sistem Monitoring Tempat Sampah Pintar Ultrasonik IoT
...
Pemantauan kapasitas volume tempat sampah berbasis sensor ultrasonik HC-SR04/JSN-SR04T dengan transmisi data level sampah real-time.
...
1. Buka file **`esp32-smart-waste-management.ino`** menggunakan **Arduino IDE 2.0+**.
